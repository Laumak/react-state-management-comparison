...
Centralising the fetch logic here means every app calls the same functions and works with the same types — the only difference is *how* each app manages the resulting state.
